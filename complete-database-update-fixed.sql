...
-- First drop the existing trigger and function to avoid conflicts
...
/*
-- First ensure there's no existing demo user
DELETE FROM auth.users WHERE email = 'demo@karmaclub.org';
